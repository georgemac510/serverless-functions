                    ...
                    (seq
                     (seq
                      (seq
                       ...
                       (ap ("dealId" "2123c949865fc716f779897f2f6be8e91d166846") %MyDeployment_obj_map)
                      )
                      (ap ("dealIdOriginal" "0x2123C949865fc716f779897F2f6bE8e91D166846") %MyDeployment_obj_map)
                     )
                     (ap ("definition" "bafkreib2dlr3am5ufadbg6jcw2kx4eoz6fvgoxotfidkq3bfbdksvfmely") %MyDeployment_obj_map)
                    )
                    (ap ("matched" false) %MyDeployment_obj_map)
                   )
                   (ap ("timestamp" "2024-05-26T15:45:51.887Z") %MyDeployment_obj_map)
                  )
